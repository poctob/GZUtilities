...
public class CryptoUtils {
	...
	/**
	 * Hashes the password using SHA512 algorithm, password can be salted if
	 * salt is provided.
	 * 
	 * @param input
	 *            Plain text password.
	...
	/**
	 * Generates new random string to use for salt. Use 120 for bits and 32 for
	 * radix when in doubt.
	 * 
	 * @param bits
	 ...
	 *            Password to check.
	 * @param salt
	 *            Salt used to hash it.
	 * @param hash
	 *            Hashed value for comparison.
	 * @return True if passwords match. False otherwise.
	 */
	public static boolean checkPassSHA512(String password, String salt,
			String hash) {
